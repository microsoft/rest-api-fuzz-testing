    ...
    if (error) {
        ...
        config.targetConfiguration.apiSpecifications.forEach(swagger => {
            ...
            let configuration = {
                ...
                reporter: ['md'], // Array of possible reporters, see folder lib/reporters
                output: ['report.md'],       // Array of Strings, filepaths to files used for output of file-based reporters
            ...
            eventEmitter.on('test pass', (test) => {
                if (runDetails[test.actual.statusCode]) {
                    runDetails[test.actual.statusCode] ++;
                } else {
                    runDetails[test.actual.statusCode] = 1;
                }
                raftUtils.reportStatusRunning(runDetails);
            });
